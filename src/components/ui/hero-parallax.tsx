...
export const HeroParallax = ({
  ...
  return (
    ...
    <div
      ref={ref}
      className="h-[260vh] min-h-screen sm:h-[390vh] md:h-[390vh] lg:h-[290vh] xl:h-[230vh] w-full overflow-hidden antialiased relative flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d]"
      >
      <Header />
      <motion.div
        style={{
