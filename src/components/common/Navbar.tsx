...
export default function Navbar() {
  const pathname = usePathname(); // ✅ Get the current URL path dynamically
                ...
                {navigation.map((item) => (
                  <Link
                    ...
                    className={classNames(
                      pathname === item.href
                        ? "bg-green-900 text-white" // ✅ Highlight based on the current path
        ...
        <div className="space-y-1 px-2 pt-2 pb-3">
          {navigation.map((item) => (
            <DisclosureButton
              ...
              className={classNames(
                pathname === item.href
                  ? "bg-gray-900 text-white" // ✅ Correctly highlight active page
